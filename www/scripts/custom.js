$(document).ready(function() {
    ...
    f.go(30), f.go(100), $(function() {
        $(".thumb-layout-page a").slice(0, 5).show(), $(".load-more-thumbs").click(function(e) {
        ...
        $(".card-small-layout-page .card-small-layout").slice(0, 3).show(), $(".load-more-small-cards").click(function(e) {
        ...
        return $("#tab-2, #tab-3").slideUp(250), $("#tab-1").slideDown(250), $(".home-tabs a").removeClass("active-home-tab"), $(".activate-tab-1").addClass("active-home-tab"), !1
    }), $(".activate-tab-2").click(function() {
        return $("#tab-1, #tab-3").slideUp(250), $("#tab-2").slideDown(250), $(".home-tabs a").removeClass("active-home-tab"), $(".activate-tab-2").addClass("active-home-tab"), !1
    }), $(".activate-tab-3").click(function() {
        return $("#tab-1, #tab-2").slideUp(250), $("#tab-3").slideDown(250), $(".home-tabs a").removeClass("active-home-tab"), $(".activate-tab-3").addClass("active-home-tab"), !1
    }), $(function() {
        $(".add-qty").on("click", function() {
            var e = $(this).closest("div").find(".qty"),
                t = parseInt(e.val());
            isNaN(t) || e.val(t + 1)
